(function (u) {
  "object" === typeof exports && "undefined" !== typeof module ? module.exports = u() : "function" === typeof define && define.amd ? define([], u) : ("undefined" !== typeof window ? window : "undefined" !== typeof global ? global : "undefined" !== typeof self ? self : this).jsmediatags = u()
})(function () {
  return function f(m, k, l) {
    function h(a, b) {
      if (!k[a]) {
        if (!m[a]) {
    ...
    for (var d = "function" == typeof require && require, a = 0; a < l.length; a++) h(l[a]);
    return h
  }({
    1: [function (f, m, k) {}, {}],
    2: [function (f, m, k) {
      m.exports = XMLHttpRequest
    }, {}],
    3: [function (f, m, k) {
      function l(d, a) {
      ...
      f = function () {
        ...
        l(h, [{
          ...
          value: function (d, a) {
            ...
            if (-1 === b.startIx) this._fileData.splice(b.insertIx || 0, 0, {
              offset: d,
              data: a
            });
            else {
              var e = this._fileData[b.startIx],
                g = this._fileData[b.endIx],
                c = c < g.offset + g.data.length - 1,
                p = {
                  offset: Math.min(d, e.offset),
                  data: a
                };
              d > e.offset && (e = e.data.slice(0,
                d - e.offset), p.data = this._concatData(e, a));
              c && (e = p.data.slice(0, g.offset - p.offset), p.data = this._concatData(e, g.data));
              this._fileData.splice(b.startIx, b.endIx - b.startIx + 1, p)
            }
          }
        }, {
          key: "_concatData",
          ...
          value: function (d, a) {
            for (var c = -1, b = -1, e = 0, g = 0; g < this._fileData.length; g++, e = g) {
              var p = this._fileData[g].offset,
                r = p + this._fileData[g].data.length;
              if (a < p - 1) break;
              if (d <= r + 1 && a >= p - 1) {
                c = g;
                break
            ...
            for (g = c; g < this._fileData.length && !(p = this._fileData[g].offset, r = p + this._fileData[g].data.length, a >= p - 1 && (b = g), a <= r + 1); g++); - 1 === b && (b = c);
            return {
              startIx: c,
              endIx: b
            }
    ...
    6: [function (f, m, k) {
      ...
      f = function (a) {
        function c() {
          if (!(this instanceof c)) throw new TypeError("Cannot call a class as a function");
          var b = Object.getPrototypeOf(c).apply(this,
            arguments);
          if (!this) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
        ...
        h(c, [{
          ...
          value: function (b, a) {
            var g = b.getSize();
            b.loadRange([g - 128, g - 1], a)
          }
        }, {
          key: "_parseData",
          value: function (b, a) {
            var g = b.getSize() - 128,
              c = b.getStringWithCharsetAt(g + 3, 30).toString(),
              r = b.getStringWithCharsetAt(g + 33, 30).toString(),
              h = b.getStringWithCharsetAt(g + 63, 30).toString(),
              f = b.getStringWithCharsetAt(g + 93, 4).toString(),
              n = b.getByteAt(g + 97 + 28),
              t = b.getByteAt(g + 97 + 29);
            if (0 == n && 0 != t) var n = "1.1",
              q = b.getStringWithCharsetAt(g + 97, 28).toString();
            else n = "1.0", q = b.getStringWithCharsetAt(g + 97, 30).toString(), t = 0;
            g = b.getByteAt(g + 97 + 30);
            c = {
              type: "ID3",
              version: n,
              tags: {
          ...
          value: function (b) {
            return "TAG" === String.fromCharCode.apply(String,
              b.slice(0, 3))
          }
        }]);
        return c
    ...
    7: [function (f, m, k) {
      ...
      f("./MediaFileReader");
      var h = {
        APIC: function (a, c, b, e, g) {
          g = g || "3";
          e = a;
          var p = l(b.getByteAt(a));
          switch (g) {
            case "2":
              var r = b.getStringAt(a + 1, 3);
              a += 4;
              break;
            case "3":
            case "4":
              r = b.getStringWithCharsetAt(a + 1, c - (a - e)), a += 1 + r.bytesReadCount
          }
          g = b.getByteAt(a, 1);
          g = d[g];
          p = b.getStringWithCharsetAt(a + 1, c -
            (a - e), p);
          a += 1 + p.bytesReadCount;
          return {
            format: r.toString(),
            type: g,
            description: p.toString(),
            data: b.getBytesAt(a, e + c - a)
          }
        },
        COMM: function (a, c, b, e, g) {
          ...
          g = b.getStringWithCharsetAt(a + 4, c - 4, d);
          a += 4 + g.bytesReadCount;
          a = b.getStringWithCharsetAt(a, p + c - a, d);
          return {
            language: e,
      ...
      h.COM = h.COMM;
      h.PIC = function (a, c, b, e, g) {
        return h.APIC(a, c, b, e, "2")
      };
      h.PCNT = function (a, c, b, e, g) {
      ...
      h.TCON = function (a, c, b, e) {
        return h["T*"].apply(this, arguments).replace(/^\(\d+\)/, "")
      };
      h.TCO = h.TCON;
      h.USLT = function (a, c, b, e, g) {
        var p = a,
          d = l(b.getByteAt(a));
        e = b.getStringAt(a + 1, 3);
        g = b.getStringWithCharsetAt(a + 4, c - 4, d);
        a += 4 + g.bytesReadCount;
        a = b.getStringWithCharsetAt(a,
          p + c - a, d);
        return {
          language: e,
      ...
      m.exports = {
        getFrameReaderFunction: function (a) {
          return a in h ? h[a] : "T" === a[0] ? h["T*"] : "W" === a[0] ? h["W*"] : null
        }
      }
    }, {
      "./MediaFileReader": 10
      ...
      f = function (b) {
        ...
        h(e, [{
          ...
          value: function (b, a) {
            b.loadRange([6, 9], {
              onSuccess: function () {
                b.loadRange([0, 10 + b.getSynchsafeInteger32At(6) - 1], a)
              },
              onError: a.onError
            })
          }
          ...
          value: function (b, a) {
            ...
            var h = b.getByteAt(e + 4),
              n = b.isBitSetAt(e + 5, 7),
              f = b.isBitSetAt(e + 5, 6),
              q = b.isBitSetAt(e + 5, 5),
              l = b.getSynchsafeInteger32At(e + 6),
              e = e + 10;
            if (f) var m = b.getLongAt(e, !0),
              e = e +
              (m + 4);
            var d = {
                type: "ID3",
                ...
                flags: {
                  unsynchronisation: n,
                  extended_header: f,
                  experimental_indicator: q,
                  footer_present: !1
                },
                size: l,
                tags: {}
              },
              e = n ? {} : this._readFrames(e, l - 10, b, d, a),
              k;
            for (k in c) c.hasOwnProperty(k) && (n = this._getFrameData(e, c[k])) && (d.tags[k] = n);
            for (var w in e) e.hasOwnProperty(w) && (d.tags[w] = e[w]);
            return d
          }
        }, {
          key: "_readFrames",
          value: function (b, a, e, c, h) {
            var n = {};
            for (h && (h = this._expandShortcutTags(h)); b < a;) {
              var f = this._readFrameHeader(e, b, c),
                q = f.id;
              if (0 === f.size) break;
              if (!q) break;
              var l = f.flags,
              ...
              h && -1 === h.indexOf(q) || l && l.format.unsynchronisation || (l && l.format.data_length_indicator && (m += 4, k -= 4), l = (f = d.getFrameReaderFunction(q)) ? f(m, k, e, l) : null, m = this._getFrameDescription(q), k = {
                id: q,
                size: k,
                description: m,
                data: l
              }, q in n ? (n[q].id && (n[q] = [n[q]]), n[q].push(k)) : n[q] = k)
            }
            return n
          }
        }, {
          ...
          value: function (b, a, e) {
            ...
            switch (e) {
              case 2:
                var d = b.getStringAt(a, 3),
                  n = b.getInteger24At(a + 3, !0),
                  f = 6;
                break;
              case 3:
                d = b.getStringAt(a, 4);
                ...
                break;
              case 4:
                d = b.getStringAt(a, 4), n = b.getSynchsafeInteger32At(a + 4), f = 10
            }
            d && 2 < e && (c = this._readFrameFlags(b, a + 8));
            return {
              id: d,
              size: n,
              headerSize: f,
          ...
          value: function (b, a) {
            return {
              ...
              format: {
                ...
                unsynchronisation: b.isBitSetAt(a +
                  1, 1),
    ...
    9: [function (f, m, k) {
      function l(b, a) {
        if ("function" !==
          typeof a && null !== a) throw new TypeError("Super expression must either be null or a function, not " + typeof a);
        b.prototype = Object.create(a && a.prototype, {
          constructor: {
            value: b,
            enumerable: !1,
        ...
        h(e, [{
          ...
          value: function (b, a, c, e) {
            if (a >= b.getSize()) e.onSuccess();
              ...
              var d = this,
                n = b.getLongAt(a, !0);
              if (0 == n || isNaN(n)) e.onSuccess();
              else {
                var f = b.getStringAt(a + 4, 4);
                if (this._isContainerAtom(f)) {
                  "meta" == f && (a += 4);
                  var h = (c ? c + "." : "") + f;
                  "moov.udta.meta.ilst" === h ? b.loadRange([a, a + n], e) : b.loadRange([a + 8, a + 8 + 8], {
                    onSuccess: function () {
                      d._loadAtom(b, a + 8, h, e)
                    },
                    onError: e.onError
                  })
                } else b.loadRange([a + n, a + n + 8], {
                  onSuccess: function () {
                    d._loadAtom(b, a + n, c, e)
                  },
                  onError: e.onError
                })
              }
          ...
          key: "_readAtom",
          value: function (b, a, c, e, d, n, f) {
            f = void 0 === f ? "" :
              f + "  ";
            for (var h = c; h < c + e;) {
              var l = a.getLongAt(h, !0);
              if (0 == l) break;
              var k = a.getStringAt(h + 4, 4);
              if (this._isContainerAtom(k)) {
                "meta" == k && (h += 4);
                this._readAtom(b, a, h + 8, l - 8, d, (n ? n + "." : "") + k, f);
                break
              }(!d || 0 <= d.indexOf(k)) && "moov.udta.meta.ilst" === n && this._canReadAtom(k) && (b[k] = this._readMetadataAtom(a, h));
              h += l
            }
          }
        }, {
          ...
          value: function (b, c) {
            var e = b.getLongAt(c, !0),
              f = b.getStringAt(c + 4, 4),
              h = b.getInteger24At(c + 16 + 1, !0),
              h = d[h],
              n;
            if ("trkn" == f) n = {
              track: b.getByteAt(c + 16 + 11),
              total: b.getByteAt(c +
                16 + 13)
            };
            else {
              ...
              switch (h) {
                case "text":
                  n = b.getStringWithCharsetAt(k, l, "utf-8").toString();
                  break;
                case "uint8":
                  n = b.getShortAt(k, !1);
                  break;
          ...
          key: "canReadTagFormat",
          value: function (b) {
            return "ftyp" === String.fromCharCode.apply(String, b.slice(4,
              8))
          }
        }]);
        return e
        ...
        l(d, [{
          ...
          value: function (a, c, b) {
            ...
            switch ((b || "").toLowerCase()) {
              ...
              case "utf-16le":
              case "utf-16be":
                b = h.readUTF16String(a, "utf-16be" === b);
                break;
              case "utf-8":
                b = h.readUTF8String(a);
                break;
              default:
                b = h.readNullTerminatedString(a)
            }
            return b
          }
        }, {
      ...
      m.exports = {
        readUTF16String: function (d, a, c) {
          ...
          for (var f = 0; b < c; f++) {
            var k = d[b + e],
              ...
              b = b + 2;
            if (0 == l) break;
            else 216 > k || 224 <= k ? a[f] = String.fromCharCode(l) :
        ...
        readUTF8String: function (d, a) {
          ...
          for (var b = [], e = 0; c < a; e++) {
            var g = d[c++];
            if (0 == g) break;
            else if (128 > g) b[e] = String.fromCharCode(g);
            else if (194 <= g && 224 > g) {
              var f = d[c++];
              b[e] = String.fromCharCode(((g & 31) << 6) + (f & 63))
            } else if (224 <= g && 240 > g) {
              var f = d[c++],
                k = d[c++];
              b[e] = String.fromCharCode(((g & 255) << 12) + ((f & 63) << 6) + (k & 63))
            } else if (240 <= g && 245 > g) {
              var f =
                d[c++],
                k = d[c++],
                l = d[c++],
                g = ((g & 7) << 18) + ((f & 63) << 12) + ((k & 63) << 6) + (l & 63) - 65536;
              b[e] = String.fromCharCode((g >> 10) + 55296, (g & 1023) + 56320)
            }
          }
    ...
    13: [function (f, m, k) {
      ...
      k = function (a) {
        ...
        h(c, [{
          key: "_init",
          value: function (b) {
            c._config.avoidHeadRequests ? this._fetchSizeWithGetRequest(b) : this._fetchSizeWithHeadRequest(b)
          }
        }, {
          ...
          value: function (b) {
            ...
            this._makeXHRRequest("HEAD", null, {
              onSuccess: function (c) {
                (c = a._parseContentLength(c)) ?
                (a._size = c, b.onSuccess()) : a._fetchSizeWithGetRequest(b)
              },
              onError: b.onError
            })
          }
          ...
          value: function (b) {
            return b.responseBody || b.responseText || ""
          }
        }, {
          key: "_parseContentLength",
          value: function (b) {
            b = this._getResponseHeader(b, "Content-Length");
            return null == b ? b : parseInt(b, 10)
          }
        }, {
          ...
          value: function (b) {
            if (b = this._getResponseHeader(b, "Content-Range")) {
              ...
              if (!a) throw Error("FIXME: Unknown Content-Range syntax: ", b);
              return {
                firstBytePosition: parseInt(a[1], 10),
                lastBytePosition: parseInt(a[2], 10),
                instanceLength: a[3] ? parseInt(a[3], 10) : null
              }
            }
            return null
          }
          ...
          value: function (b, a) {
            var c = this;
            c._fileData.hasDataRange(b[0], b[1]) ? setTimeout(a.onSuccess, 1) : (b = this._roundRangeToChunkMultiple(b), this._makeXHRRequest("GET", b, {
              onSuccess: function (d) {
                d = c._getXhrResponseContent(d);
                c._fileData.addData(b[0], d);
                a.onSuccess()
              },
              onError: a.onError
            }))
          ...
          value: function (a, c, d) {
            var f = this._createXHRObject(),
              h = function () {
                if (200 === f.status || 206 === f.status) d.onSuccess(f);
                else if (d.onError) d.onError({
                  type: "xhr",
                  info: "Unexpected HTTP status " + f.status + ".",
                  xhr: f
                });
                f = null
              };
            "undefined" !== typeof f.onload ? (f.onload = h, f.onerror = function () {
            ...
            c && this._setRequestHeader(f, "Range", "bytes=" + c[0] + "-" + c[1]);
            this._setRequestHeader(f, "If-Modified-Since", "Sat, 01 Jan 1970 00:00:00 GMT");
            f.send(null)
          }
        }, {
          key: "_setRequestHeader",
          value: function (a, d, f) {
            0 > c._config.disallowedXhrHeaders.indexOf(d.toLowerCase()) && a.setRequestHeader(d, f)
          }
        }, {
          ...
          value: function (a, c) {
            ...
            if (!d) return !1;
            for (var d = d.split("\r\n"), f = [], h = 0; h < d.length; h++) f[h] =
              d[h].split(":")[0].toLowerCase();
    ...
    14: [function (f, m, k) {
          ...
          h(a, [{
            ...
            value: function () {
              for (var a = 0; a < g.length; a++)
                if (g[a].canReadFile(this._file)) return g[a];
            ...
            value: function (a, b) {
              for (var c = [], d = [], e = a.getSize(), f = 0; f < p.length; f++) {
                var g =
                  p[f].getTagIdentifierByteRange();
                0 <= g.offset && g.offset < e / 2 || 0 > g.offset && g.offset < -e / 2 ? c.push(p[f]) : d.push(p[f])
              }
              var h = !1,
                f = {
                  onSuccess: function () {
                    if (h) {
                      for (var c = 0; c < p.length; c++) {
                        var d = p[c].getTagIdentifierByteRange(),
                          d = a.getBytesAt(0 <= d.offset ? d.offset : d.offset + e, d.length);
                        if (p[c].canReadTagFormat(d)) {
                          b.onSuccess(p[c]);
                          return
                        }
                      }
              ...
              this._loadTagIdentifierRanges(a,
                d, f)
            }
          }, {
      ...
      v.addFileReader(d).addFileReader(a).addFileReader(c).addTagReader(e).addTagReader(b).addTagReader(f);
      "undefined" !== typeof process && v.addFileReader(k);
      m.exports = {
        read: function (a, b) {
          (new r(a)).read(b)
        },
